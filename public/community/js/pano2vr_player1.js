...
function Ib(h, q, p) {
    ...
    if (X) {
        ...
        var wa = Math.sin(q),
            ...
            B = m * p * oa - B * wa,
            m = p * p * oa + Va;
        H ? h != H && (H[12] = h[12], H[13] = h[13], H[14] = h[14], H[15] = h[15]) : H = h;
...
function Mc() {
    ...
    "undefined" !== typeof document.documentElement.style[h] ? "webkitPerspective" in document.documentElement.style ? (h = document.createElement("style"), q = document.createElement("div"), p = document.head || document.getElementsByTagName("head")[0], h.textContent = "@media (-webkit-transform-3d) {#ggswhtml5{height:5px}}", p.appendChild(h), q.id = "ggswhtml5", document.documentElement.appendChild(q), p = 5 === q.offsetHeight, h.parentNode.removeChild(h), q.parentNode.removeChild(q)) : p = l : p = r;
    return p
}
function Nc() {
    var h;
...
function pano2vrPlayer(h) {
    ...
    function B(a) {
        for (var d = 0; d < C.length; d++) if (C[d].id == a) return C[d];
        for (d = 0; d < y.length; d++) if (y[d].id == a) return y[d];
        for (d = 0; d < fa.length; d++) if (fa[d].id == a) return fa[d];
        return o
    }
    function m(a) {
        try {
            ...
            if (1 == a.u || 4 == a.u) a.o = function() {
                ...
                a.oa = l;
                bc()
            }, a.obj.addEventListener(wa(), a.ea, r), a.obj.addEventListener("transitionend", a.ea, r);
    ...
    function X(a) {
        try {
            ...
            if (1 == a.u || 4 == a.u) a.o = function() {
                ...
                a.v = c;
                a.v ? (a.obj.style.zIndex = 8E4, a.obj.style[xa] = "all 1s ease 0s", b.playSound(a.id)) : (a.obj.style.zIndex = 0, a.obj.style[xa] = "all 1s ease 0s");
                a.oa = l;
                bc()
            }, a.obj.addEventListener(wa(), a.ea, r), a.obj.addEventListener("transitionend", a.ea, r);
            2 == a.u && (a.o = function() {
            ...
            "" != a.poster && (a.obj.poster = pa(a.poster), 0 > a.loop && (a.obj.jb = "none"));
            a.obj.volume = a.i * Y;
    ...
    function Va(a) {
        ...
        try {
            ...
            if (-1 == d) {
                for (c = 0; c < C.length; c++) if (C[c].id == a.id && C[c].obj != o) {
                    try {
                        C[c].obj.pause()
                    } catch (f) {}
                    try {
                ...
                for (c = 0; c < a.url.length; c++) {
                    ...
                    "" != a.url[c] && "#" != a.url[c] && (g.setAttribute("src", pa(a.url[c])), a.obj.appendChild(g))
                }
                a.obj.volume = a.i * Y;
                0 == a.loop && (a.obj.r = 1E7);
                1 <= a.loop && (a.obj.r = a.loop - 1);
    ...
    function rb() {
        ...
        for (var d = 0; d < C.length + y.length; d++) {
            ...
            if (c.obj) {
                var b;
                b = c.pan - u;
                for (var e = c.tilt - x; - 180 > b;) b += 360;
                for (; 180 < b;) b -= 360;
                var g = c.ca,
                    F = c.field;
                0 == F && (F = 0.01);
                ...
                if (3 == c.mode) {
                    ...
                    var k = c.i,
                        ...
                        e = e < c.N ? 0 : e - c.N,
                        n = 1 - e / F;
                    if (Math.abs(b) > F || 0 > n) c.obj.volume = k * g * Y;
                    else {
                        var h = 1 - Math.abs(b / F);
                        c.obj.volume = k * (g + (1 - g) * n * h) * Y
                    }
                }
                4 == c.mode && c.hb == o && (Math.abs(b) < c.s && Math.abs(e) < c.N ? c.ha || (c.ha = l, c.obj.play()) : c.ha = r);
                5 == c.mode && (b = 180 * Math.acos(a.wa(c.n)) / Math.PI, b < c.s ? c.obj.volume = c.i * Y : (b -= c.s, b < F && 0 < F ? (h = 1 - Math.abs(b / F), c.obj.volume = c.i * (g + (1 - g) * h) * Y) : c.obj.volume = g * Y));
    ...
    function Da() {
        var a = new Date;
        ec = 0;
        fc && (b.setViewerSize(b.da.offsetWidth, b.da.offsetHeight), fc = r, Oc());
        0 <= Q && (Pa ? (qa = 0.4 * (Fa - tb), ra = 0.4 * (Ga - ub), tb += qa, ub += ra) : (qa = 0.1 * -vb * gb / 8, ra = 0.1 * -wb * gb / 8), Pc(qa, ra), b.update());
        xb && (b.changeFov(0.4 * (V - A)), 0.001 > Math.abs(V - A) / A && (xb = r), b.update());
        if (gc && (0 != qa || 0 != ra) && 0 > Q) qa *= 0.9, ra *= 0.9, 0.1 > qa * qa + ra * ra ? ra = qa = 0 : (Pc(qa, ra), b.update());
        if (0 != Qa) {
            var d = gb / 8;
            switch (Qa) {
                case 37:
        ...
        if (!b.isLoaded && b.hasConfig) {
            ...
            if (yb) f = 50, hc < f && hc++, c = hc;
            else for (d = 0; d < f; d++) b.checkLoaded[d].complete && "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAIAAABLbSncAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA5JREFUeNpiYBgeACDAAADIAAE3iTbkAAAAAElFTkSuQmCC" != b.checkLoaded[d].src && c++;
            c == f ? (Kb = 1, b.isLoaded = l, b.divSkin && b.divSkin.ggLoaded && b.divSkin.ggLoaded()) : Kb = c / (1 * f)
        }
        for (; 360 < u;) u -= 360;
        for (; - 360 > u;) u += 360;
        if (zb) {
            ...
            if (10 * c < d) {
                if (zb = r, N = O = G = 0, b.onMoveComplete) b.onMoveComplete()
            } else c = c > 5 * d ? d / c : 0.2, G *= c, O *= c, N *= c;
            u += G;
            x += O;
            A += N;
            lc = a.getTime();
            b.update()
        } else if (ia) if (d = a.getTime() - jb, 0 < mc && b.Ba && d >= 1E3 * mc) {
            if (1 < va.length) {
                if (Rc) {
                    d = 1E3;
                    do c = va[Math.floor(Math.random() * va.length)];
                    while (d-- && c == Jb)
                } else d = va.indexOf(Jb), d++, d >= va.length && (d = 0), c = va[d];
                jb = a.getTime();
                b.openNext("{" + c + "}")
            }
        } else O = Lb * (0 - x) / 100, N = Lb * (Mb - A) / 100, G = 0.95 * G + 0.05 * -Ra * ha(), u += G, x += O, A += N, b.update();
        else {
            if (Ab && 0 > Q && a.getTime() - lc > 1E3 * nc && (oc && b.isLoaded || !oc)) ia = l, jb = a.getTime(), N = O = G = 0;
            if (gc && 0 == Qa && 0 > Q && (0 != G || 0 != O || 0 != N)) G *= 0.9, O *= 0.9, N *= 0.9, u += G, x += O, b.changeFovLog(N), 1.0E-4 > G * G + O * O + N * N && (N = O = G = 0), b.update()
        }
        Sc && (Nb ? a.getTime() - pc >= 1E3 * Tc && (Nb = r) : (Sa += kb, 0 > Sa && (Sa = 0, kb = -kb, Nb = l, pc = a.getTime()), 1 < Sa && (Sa = 1, kb = -kb, Nb = l, pc = a.getTime()), b.setOverlayOpacity(Sa)));
        if (0 < y.length) for (d = 0; d < y.length; d++) y[d].Ra && y[d].$a != y[d].obj.currentTime && (y[d].$a = y[d].obj.currentTime, !y[d].Va && 0 < y[d].obj.videoHeight && (y[d].Va = y[d].obj.videoWidth / y[d].obj.videoHeight));
        if (0 < R) {
            if (2 == R) for (d = 0; d < J.length; d++) a = J[d], "poly" == a.type && a.C != a.p && (a.C > a.p ? (a.p += 0.05, a.C < a.p && (a.p = a.C)) : (a.p -= 0.05, a.C > a.p && (a.p = a.C)), b.update());
            3 == R && ya != ja && (ya > ja ? (ja += 0.05, ya < ja && (ja = ya)) : (ja -= 0.05, ya > ja && (ja = ya)), b.update())
        }
        rb();
    ...
    function Ya(a) {
        ...
        "" != a.url && (b.openUrl(a.url, a.target), Wc(-1, -1))
    }
    function Ea() {
        b.isFullscreen && (Ob() || b.exitFullscreen(), Ob() && (b.c.style.left = "0px", b.c.style.top = "0px"))
    }
    function Za() {
        Qa = 0
    }
    function $a(a) {
        Qa && (Qa = 0, a.preventDefault(), K())
    }
    function ab(a) {
        Pb || (b.isFullscreen && a.preventDefault(), Qa = a.keyCode, K())
    }
    function Na(a) {
        ca || (a.preventDefault(), K(), Ta && Ta.reset())
    }
    function bb(a) {
        ca || (a.preventDefault(), 1 != a.scale && (xb = l, Qb *= a.scale, V = lb / Math.sqrt(Qb), V > sa && (V = sa), V < ka && (V = ka), b.update(), K()))
    }
    function cb(a) {
        !ca && Ha(a.target) && (a.preventDefault(), xb = l, V = lb / Math.sqrt(a.scale), V > sa && (V = sa), V < ka && (V = ka), b.update(), K())
    }
    function Oa(a) {
        qc = l;
        Qb = 1;
        ca || (a.touches ? (b.m = a.touches.target, Ha(a.target) && (a.preventDefault(), lb = A, K())) : (a.preventDefault(), lb = A, K()))
    }
    function db(a) {
        !Ta && window.MSGesture && (Ta = new MSGesture, Ta.target = b.control);
    ...
    function fb(a) {
        ...
        if (!ca) {
            ...
            if (0 <= d && 20 > d) {
                a.preventDefault();
                if (Ha(b.m) && (f = rc(b.mouse.x, b.mouse.y))) b.hotspot = f;
                if (b.m) {
                    d = b.m;
                ...
                if (700 > c - b.fa && 0 <= d && 20 > d) {
                    ...
                    if (b.m) {
                        d = b.m;
                        for (e = r; d && d != b.control;) d.ondblclick && !e && (d.ondblclick(), e = l, g = r), d = d.parentNode
                    }
                    b.fa = 0
                } else b.fa = c;
                Zc = Bb;
    ...
    function Ld(a) {
        ...
        if (!ca) {
            d[0] && (Bb = d[0].pageX, Cb = d[0].pageY);
            if (0 <= Q) {
                a.preventDefault();
                for (c = 0; c < d.length; c++) if (d[c].identifier == Q) {
                    ad(d[c].pageX, d[c].pageY);
                    break
                }
                K()
            }
            2 == d.length && d[0] && d[1] && (Q = -6, qc || (bd = Math.sqrt((d[0].pageX - d[1].pageX) * (d[0].pageX - d[1].pageX) + (d[0].pageY - d[1].pageY) * (d[0].pageY - d[1].pageY)), xb = l, V = lb * Math.sqrt(cd / bd), V > sa && (V = sa), V < ka && (V = ka), K(), a.preventDefault()))
        }
    }
    function Md(a) {
        a || (a = window.event);
        ...
        if (!ca) {
            if (0 > Q && d[0]) {
                ...
                b.m = d[0].target;
                if (Ha(a.target)) {
                    if ((c = dd(b.mouse.x, b.mouse.y)) && c.o) c.o();
                    else {
                        var c = d[0].pageX,
                            f = d[0].pageY;
                        uc = c;
            ...
            1 < d.length && (Q = -5);
            !qc && 2 == d.length && d[0] && d[1] && (cd = Math.sqrt((d[0].pageX - d[1].pageX) * (d[0].pageX - d[1].pageX) + (d[0].pageY - d[1].pageY) * (d[0].pageY - d[1].pageY)), lb = A);
            wb = vb = 0
        }
    }
    function wc(a) {
        if (!xc && (a = a ? a : window.event, Ha(a.target))) {
            var d = a.detail ? -1 * a.detail : a.wheelDelta / 40;
            ed && (d = -d);
            a.axis && (-1 == Rb ? Rb = a.axis : Rb != a.axis && (d = 0));
            var c = 0 < d ? 1 : -1;
            0 != d && (b.changeFovLog(c * fd, l), b.update());
            a.preventDefault();
            K()
        }
    }
    function gd(a) {
        ...
        if (!ca && 0 <= Q) {
            ...
            400 > a - tc && 0 <= d && 20 > d && ((d = rc(b.mouse.x, b.mouse.y)) && Ya(d), d = Math.abs(hd - Fa) + Math.abs(id - Ga), 700 > a - b.fa && 0 <= d && 20 > d ? (sc && setTimeout(function() {
                b.toggleFullscreen()
            }, 10), b.fa = 0) : b.fa = a, hd = Fa, id = Ga);
            K()
        }
    }
    function jd(a) {
        var a = a ? a : window.event,
            d = Db();
        Ob() ? (b.mouse.x = a.clientX - Z, b.mouse.y = a.clientY - ba) : (b.mouse.x = a.pageX - d.x, b.mouse.y = a.pageY - d.y);
        if (!ca && (0 <= Q && (a.preventDefault(), (a.which || 0 == a.which || 1 == a.which) && ad(a.pageX, a.pageY), K()), b.hotspot == b.emptyHotspot || "poly" == b.hotspot.type)) {
            var c = b.emptyHotspot;
            0 < J.length && Ha(a.target) && (c = rc(b.mouse.x, b.mouse.y));
            b.hotspot != c && (b.hotspot != b.emptyHotspot && (0 < R && (b.hotspot.C = 0), b.skinObj && b.skinObj.hotspotProxyOut && b.skinObj.hotspotProxyOut(b.hotspot.id)), c ? (b.hotspot = c, b.skinObj && b.skinObj.hotspotProxyOver && b.skinObj.hotspotProxyOver(b.hotspot.id), S.style.cursor = "pointer", 0 < R && (ya = 1, b.hotspot.C = 1)) : (b.hotspot = b.emptyHotspot, S.style.cursor = "auto", 0 < R && (ya = 0)));
            Wc(a.pageX - d.x, a.pageY - d.y)
        }
    }
    function Wc(a, d) {
        var c = Sb;
        c.enabled && (b.hotspot != b.emptyHotspot && 0 <= a && 0 <= d && "" != b.hotspot.title ? (M.innerHTML = b.hotspot.title, M.style.color = Ia(c.Ea, c.Da), M.style.backgroundColor = c.background ? Ia(c.P, c.O) : "transparent", M.style.border = "solid " + Ia(c.R, c.Q) + " " + c.ya + "px", M.style.borderRadius = c.xa + "px", M.style.textAlign = "center", 0 < c.width ? (M.style.left = a - c.width / 2 + Z + "px", M.style.width = c.width + "px") : (M.style.width = "auto", M.style.left = a - M.offsetWidth / 2 + Z + "px"), M.style.height = 0 < c.height ? c.height + "px" : "auto", M.style.top = d + 25 + +ba + "px", M.style.visibility = "inherit", M.style.overflow = "hidden") : (M.style.visibility = "hidden", M.innerHTML = ""))
    }
    function kd(a) {
        var d = Db();
        Ob() ? (b.mouse.x = a.clientX - Z, b.mouse.y = a.clientY - ba) : (b.mouse.x = a.pageX - d.x, b.mouse.y = a.pageY - d.y);
        ...
        if (!ca) {
            ...
            if ((a.which || 0 == a.which || 1 == a.which) && Ha(a.target)) {
                if ((d = dd(b.mouse.x, b.mouse.y)) && d.o) d.o();
                else {
                    var d = a.pageX,
                        c = a.pageY;
                    uc = d;
    ...
    function dd(a, d) {
        ...
        for (f = 0; f < y.length + fa.length; f++) {
            ...
            var g = [],
                F = new P,
                k, n, h;
            0 < e.J && (n = Math.tan(e.J / 2 * Math.PI / 180), h = 0 < e.z ? n * e.D / e.z : n, e.L && 1 != e.L && (h *= e.L));
            for (k = 0; 4 > k; k++) {
                switch (k) {
                    case 0:
                        F.q(-n, -h, -1);
    ...
    function nd() {
        var a, d;
        if (da) for (; 0 < da.length;) g.deleteTexture(da.pop());
        da = [];
        for (var c = 0; 6 > c; c++) d = g.createTexture(), d.va = o, d.ra = o, d.Qa = r, g.bindTexture(g.TEXTURE_2D, d), g.texImage2D(g.TEXTURE_2D, 0, g.RGB, 1, 1, 0, g.RGB, g.UNSIGNED_BYTE, o), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, g.CLAMP_TO_EDGE), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, g.CLAMP_TO_EDGE), mb[c] && (a = new Image, a.crossOrigin = b.ba, a.src = pa(mb[c]), d.va = a, a.addEventListener && a.addEventListener("load", Bc(d), r), b.checkLoaded.push(a)), da.push(d);
        for (c = 0; 6 > c; c++) Wb[c] && (a = new Image, a.crossOrigin = b.ba, a.src = pa(Wb[c]), a.addEventListener ? a.addEventListener("load", Bc(da[c]), r) : a.onload = Bc(da[c]), da[c].ra = a, b.checkLoaded.push(a));
        for (c = 0; c < y.length; c++) y[c].gb = g.createTexture(), g.bindTexture(g.TEXTURE_2D, y[c].gb), g.texImage2D(g.TEXTURE_2D, 0, g.RGB, 1, 1, 0, g.RGB, g.UNSIGNED_BYTE, o), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, g.CLAMP_TO_EDGE), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, g.CLAMP_TO_EDGE);
    ...
    function od(a) {
        ...
        for (var k = 0; 3 > k; k++) g = Ja(g, "c", d), g = Ja(g, "s", h), g = Ja(g, "r", a), g = Ja(g, "l", e), g = Ja(g, "x", c), g = Ja(g, "y", b), g = Ja(g, "v", b), g = Ja(g, "h", c);
        return pa(g)
    }
    function Ja(a, d, c) {
    ...
    function Bc(a) {
        return function() {
            try {
                ...
                d && (g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MAG_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, g.CLAMP_TO_EDGE), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, g.CLAMP_TO_EDGE), a.loaded = l);
                g.bindTexture(g.TEXTURE_2D, o)
            } catch (c) {}
            b.update()
        }
    ...
    function bc() {
        ...
        for (d = 0; d < y.length + fa.length; d++) {
            ...
            c.Za != f && (c.Za = f, c.obj.style[T] = f, c.obj.style.left = Z + z / 2 + "px", c.obj.style.top = ba + t / 2 + "px", c.obj.style.visibility = "visible", c.oa && c.Ya == c.v && (c.obj.style[xa] = "all 0s linear 0s"), c.Ya = c.v)
        }
    }
    function rd() {
        for (var a = 0, d = Math.tan(b.getVFov() * Math.PI / 360), c = t / (2 * d), c = c * (1 + d * (z / t) / 2), c = c * Math.pow(2, sd); D.length >= a + 2 && !D[a + 1].Ta && D[a + 1].width > c;) a++;
        return a
    }
    function td() {
    ...
    function ud() {
        ...
        for (a = 0; 6 > a; a++) {
            ...
            if (d.F) {
                ...
                for (var f = 0; f < c.length; f++) 4 > a ? c[f].l(a * (-Math.PI / 2)) : c[f].k((4 == a ? -1 : 1) * (Math.PI / 2)), c[f].l(-u * Math.PI / 180), c[f].k(x * Math.PI / 180), c[f].B(la * Math.PI / 180);
                c = Tb(c);
                for (var e = {
                    ma: 1,
                    na: 1,
                    pa: 0,
                    qa: 0
                }, f = 0; f < c.length; f++) e.ma = Math.min(e.ma, c[f].I), e.pa = Math.max(e.pa, c[f].I), e.na = Math.min(e.na, c[f].n), e.qa = Math.max(e.qa, c[f].n);
                e.Ga = e.pa - e.ma;
                e.Ka = e.qa - e.na;
    ...
    function Od(a) {
        return function() {
            ...
            0 == U && b.divSkin && b.divSkin.ggLoadedLevels && b.divSkin.ggLoadedLevels();
            try {
                g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL, l), a.a != o && a.a.complete && (a.M = g.createTexture(), g.bindTexture(g.TEXTURE_2D, a.M), g.texImage2D(g.TEXTURE_2D, 0, g.RGBA, g.RGBA, g.UNSIGNED_BYTE, a.a), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MAG_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_MIN_FILTER, g.LINEAR), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_S, g.CLAMP_TO_EDGE), g.texParameteri(g.TEXTURE_2D, g.TEXTURE_WRAP_T, g.CLAMP_TO_EDGE), g.bindTexture(g.TEXTURE_2D, o))
            } catch (d) {}
            b.update()
        }
    }
    function Ua() {
        var a, d;
        0 < Cc && (a = nb, D && 0 < D.length && (a = D[0].height), ka = 360 * Math.atan2(t / 2, a / 2 * Cc) / Math.PI);
        A < ka && (A = ka);
        A > sa && (A = sa);
        d = b.getVFov() / 2;
        ...
        2 * d > Ka - La && (d = (Ka - La) / 2);
        b.setVFov(2 * d);
        90 > Ka ? x + d > Ka && (x = Ka - d) : x > Ka && (x = Ka); - 90 < La ? x - d < La && (x = La + d) : x < La && (x = La);
        if (359.99 > hb - ib) {
            var c = 0;
            if (0 != x) {
                var f, e = t / 2;
                ...
                e -= f;
                0 < e && (c = 180 * Math.atan(1 / (e / f)) / Math.PI, c = c * (hb - ib) / 360)
            }
            u + (a + c) > hb && (u = hb - (a + c), ia && (Ra = -Ra, G = 0));
            u - (a + c) < ib && (u = ib + (a + c), ia && (Ra = -Ra, G = 0));
            90 < x + d && (x = 90 - d); - 90 > x - d && (x = -90 + d)
        }
    }
    function rc(a, d) {
        var c = -1;
        if (0 <= R) for (var b = 0; b < J.length; b++) {
            var e = J[b];
    ...
    function Oc() {
        for (var a = new P(0, 0, -100), d = b.S(), c = 0; c < J.length; c++) {
            ...
            if ("point" == f.type) {
                ...
                f.obj && f.obj.__div && (f.obj.__div.style[xa] = "none", f.obj.ggUse3d ? (ma || qd(d), f.obj.__div.style.width = "1px", f.obj.__div.style.height = "1px", hs = "", ma && (hs += "perspective(" + d + "px) "), hs += "translate3d(0px,0px," + d + "px) ", hs += "rotateZ(" + la.toFixed(10) + "deg) ", hs += "rotateX(" + x.toFixed(10) + "deg) ", hs += "rotateY(" + (-u).toFixed(10) + "deg) ", hs += "rotateY(" + f.pan.toFixed(10) + "deg) ", hs += "rotateX(" + (-f.tilt).toFixed(10) + "deg) ", hs += "translate3d(0px,0px," + (-1 * f.obj.gg3dDistance).toFixed(10) + "px) ", f.obj.__div.style[T + "Origin"] = "0% 0%", f.obj.__div.style[T] = hs, f.obj.__div.style.left = Z + z / 2 + "px", f.obj.__div.style.top = ba + t / 2 + "px") : h ? (f.obj.__div.style.left = Z + e + z / 2 + "px", f.obj.__div.style.top = ba + g + t / 2 + "px") : (f.obj.__div.style.left = "-1000px", f.obj.__div.style.top = "-1000px"))
            }
            if ("poly" == f.type) {
                for (var k = [], h = 0; h < f.ia.length; h++) e = f.ia[h], a.q(0, 0, -100), a.k(-e.tilt * Math.PI / 180), a.l(e.pan * Math.PI / 180), a.l(-u * Math.PI / 180), a.k(x * Math.PI / 180), a.B(la * Math.PI / 180), k.push(a.La());
                k = Tb(k);
                if (0 < k.length) for (h = 0; h < k.length; h++) a = k[h], 0.1 > a.e ? (g = -d / a.e, e = z / 2 + a.x * g, g = t / 2 + a.y * g) : g = e = 0, a.$ = e, a.G = g;
                f.ua = k
            }
        }
    }
    function qd(a) {
        !ma && b.cb != a && (b.cb = a, S.style[za] = a + "px", S.style[za + "Origin"] = Z + z / 2 + "px " + (ba + t / 2) + "px ", s.style[za] = a + "px", s.style[za + "Origin"] = Z + z / 2 + "px " + (ba + t / 2) + "px ")
    }
    function Tb(a) {
        a = Fb(a, yd);
        a = Fb(a, zd);
    ...
    function Pd(a, b) {
        ...
        if (b.skinid == 'no') {
            ...
            var f;
            c.a.setAttribute("src", "data:image/png;base64,");
            c.a.setAttribute("style", "position: absolute;top: -15px;left: -25px;width: 50px;height: 30px; cursor: pointer;" + I + "user-select: none;");
            ...
            c.a = document.createElement("img");
            var f;
            c.a.setAttribute("src", "data:image/png;base64,");
            c.a.setAttribute("style", "position: absolute;top: -15px;left: -25px;width:50px;height:30px;cursor:pointer;" + I + "user-select: none;");
            c.a.ondragstart = function() {
                return r
            };
        ...
        var e = Sb;
        e.enabled && (c.text = document.createElement("div"), f = "position:absolute;" + ("left: 26px;"), f = f + "top:  -11px;" + ("width: " + b.w + "px;"), f = 0 == b.h ? f + "height: auto;" : f + ("height: " + b.h + "px;"), b.wordwrap ? f = f + "white-space: pre-wrap;" + ("width: " + b.w + "px;") : (f = 0 == b.h ? f + "width: auto;" : f + ("width: " + b.w + "px;"), f += "white-space: nowrap;"), f += I + "transform-origin: 50% 50%;", c.text.setAttribute("style", f + "visibility: visible;cursor:pointer;line-height:20px;font-size: 13px;heightborder: 1px solid #000000;background-color: #ffffff;text-align: center;overflow: hidden;padding: 0px 1px 0px 1px;"), c.text.style.color = Ia(e.Ea, e.Da), c.text.style.backgroundColor = e.background ? Ia(e.P, e.O) : "transparent", c.text.style.border = "solid " + Ia(e.R, e.Q) + " " + e.ya + "px", c.text.style.borderRadius = e.xa + "px", c.text.style.textAlign = "center", c.text.style.width = 0 < e.width ? e.width + "px" : "auto", c.text.style.height = 0 < e.height ? e.height + "px" : "auto", c.text.style.overflow = "hidden", c.text.innerHTML = b.title, c.__div.onmouseover = function() {
            0 == b.h && (w = c.text.offsetWidth, c.text.style);
            c.text.style.visibility = "inherit"
        }, c.__div.onmouseout = function() {
            c.text.style.visibility = "visible";
    ...
    b.detectBrowser = function() {
        ...
        T = "transform";
        za = "perspective";
        for (d = 0; d < a.length; d++)"undefined" !== typeof document.documentElement.style[a[d] + "Transform"] && (I = "-" + a[d].toLowerCase() + "-", xa = a[d] + "Transition", T = a[d] + "Transform", za = a[d] + "Perspective");
        Gd = Mc();
        ga = Nc();
        Ca = Mc();
        ga && (Ca = r);
    ...
    b.setViewerSize = function(a, d) {
        ...
        if (!(10 > c || 10 > f)) {
            ...
            s.style.top = ba + "px";
            if (ga) try {
                Ba && (Ba.width = c, Ba.height = f), g && (g.Ja = c, g.Ia = f, g.viewport(0, 0, c, f))
            } catch (e) {
                alert(e)
            }
            na && (na.style.width = a + "px", na.style.height = d + "px", na.width = a, na.height = d);
            S && (S.style.width = a + "px", S.style.height = d + "px", $.style.width = a + "px", $.style.height = d + "px", $.width = a, $.height = d, $.style.left = Z + "px", $.style.top = ba + "px", b.divSkin && b.divSkin != S && (b.divSkin.style.width = a + "px", b.divSkin.style.height = d + "px"));
    ...
    b.updatePanorama = function() {
        ...
        Cd.q(0, -c, -f);
        Oc();
        if ($ && (Hc != R && (Hc = R, $.style.visibility = 0 < R ? "inherit" : "hidden"), 0 < R)) {
            W || (W = $.getContext("2d"));
            if (W.width != z || W.height != t) W.width = z, W.height = t;
            W.clear ? W.clear() : W.clearRect(0, 0, $.width, $.height);
            a = 1;
            3 == R && (a = ja);
            for (f = 0; f < J.length; f++) if (d = J[f], "poly" == d.type && (c = d.ua, 2 == R && (a = d.p), W.fillStyle = Ia(d.P, d.O * a), W.strokeStyle = Ia(d.R, d.Q * a), 0 < c.length)) {
                W.beginPath();
                for (j = 0; j < c.length; j++) v = c[j], 0 == j ? W.moveTo(v.$, v.G) : W.lineTo(v.$, v.G);
                W.closePath();
                W.stroke();
                W.fill()
            }
        ...
        if (ga) if (0 < D.length) {
            ...
            if (g) {
                ...
                for (h = D.length - 1; h >= e;) {
                    ...
                    for (curCfNr = 0; 6 > curCfNr; curCfNr++) if (f = b.f.j[curCfNr], d = f.ta, ua(ea), Ib(ea, -la * Math.PI / 180, [0, 0, 1]), Ib(ea, -x * Math.PI / 180, [1, 0, 0]), Ib(ea, (180 - u) * Math.PI / 180, [0, 1, 0]), 4 > curCfNr ? Ib(ea, -Math.PI / 2 * curCfNr, [0, 1, 0]) : Ib(ea, Math.PI / 2 * (5 == curCfNr ? 1 : -1), [1, 0, 0]), f.F && d && 0 < d.Ga && 0 < d.Ka && 0 < d.scale || level.t) {
                        f.dirty = r;
                        level.t ? (c = {
                            U: 0,
                            V: 0
                        }, c.Y = level.H - 1, c.Z = level.aa - 1) : c = vd(d);
                        for (ty = c.V; ty <= c.Z; ty++) for (tx = c.U; tx <= c.Y; tx++) {
                            var m = tx + ty * level.H + curCfNr * level.H * level.aa;
                            (d = level.g[m]) || (d = level.g[m] = {});
                            U < Zb && !d.a && (Fd++, d.a = new Image, d.a.onload = Od(d), d.a.onerror = xd(), d.a.onabort = xd(), d.a.crossOrigin = b.ba, d.a.setAttribute("src", od(h)), level.t && b.checkLoaded.push(d.a), 0 == U && b.divSkin && b.divSkin.ggReLoadedLevels && b.divSkin.ggReLoadedLevels(), U++, b.dirty = l);
                            if (d.M) {
                ...
                for (e = 0; e < D.length; e++) {
                    level = D[e];
                    for (var n in level.g) level.g.hasOwnProperty(n) && (d = level.g[n], !d.ja && !level.t && (d.M && g.deleteTexture(d.M), d.a = o, delete level.g[n]))
                }
                b.T = r
            }
        } else {
            ...
            if (g) {
                ...
                ac(b.getVFov(), g.Ja / g.Ia, Ma);
                g.uniformMatrix4fv(E.sa, r, Ma);
                for (v = 0; 6 > v; v++) ua(ea), Ib(ea, -la * Math.PI / 180, [0, 0, 1]), Ib(ea, -x * Math.PI / 180, [1, 0, 0]), Ib(ea, (180 - u) * Math.PI / 180, [0, 1, 0]), 4 > v ? Ib(ea, -Math.PI / 2 * v, [0, 1, 0]) : Ib(ea, Math.PI / 2 * (5 == v ? 1 : -1), [1, 0, 0]), g.bindBuffer(g.ARRAY_BUFFER, Ac), g.vertexAttribPointer(E.Ha, 3, g.FLOAT, r, 0, 0), g.bindBuffer(g.ARRAY_BUFFER, Ub), g.vertexAttribPointer(E.Fa, 2, g.FLOAT, r, 0, 0), 6 <= da.length && da[v].loaded && (g.activeTexture(g.TEXTURE0), g.bindTexture(g.TEXTURE_2D, da[v]), g.bindBuffer(g.ELEMENT_ARRAY_BUFFER, Vb), g.uniform1i(E.Ua, 0), g.uniformMatrix4fv(E.Sa, r, ea), g.uniformMatrix4fv(E.sa, r, Ma), g.drawElements(g.TRIANGLES, 6, g.UNSIGNED_SHORT, 0))
            }
        } else if (Ca) if (0 < D.length) {
            Ua();
            n = n = a = r;
            Jd++;
            if (z != s.offsetWidth || t != s.offsetHeight) z = parseInt(s.offsetWidth), t = parseInt(s.offsetHeight), s.style[T + "OriginX"] = z / 2 + "px", s.style[T + "OriginY"] = t / 2 + "px", a = l;
            h = Math.round(b.S());
            if (b.ga != h || a) b.ga = h, ma || (s.style[za] = h + "px", s.style[za + "Origin"] = "50% 50%");
            b.f.za(u, x);
            Zb = 1;
            if (0 < D.length) {
                ud();
                ...
                d = 0;
                a = "";
                for (curCfNr = 0; 6 > curCfNr; curCfNr++) f = b.f.j[curCfNr], f.F && (d = Math.max(d, f.ta.scale), a = a + curCfNr + ",");
                d = rd();
                for (c = D.length - 1; c >= d;) {
                    level = D[c];
                    m = 1;
                    c == D.length - 1 && 0 == ta && (m = L / (L - 2));
                    for (curCfNr = 0; 6 > curCfNr; curCfNr++) if (f = b.f.j[curCfNr], k = f.ta, f.F && k && 0 < k.Ga && 0 < k.Ka && 0 < k.scale || level.t) {
                        f.dirty = r;
                        var p;
                        level.t ? (p = {
                            U: 0,
                            V: 0
                        }, p.Y = level.H - 1, p.Z = level.aa - 1) : p = vd(k);
                        for (ty = p.V; ty <= p.Z; ty++) for (tx = p.U; tx <= p.Y; tx++) {
                            ...
                            if (!k.b && U < Zb) {
                                if (0 < unusedTileCanvas.length) {
                                    ...
                                    for (q = s.firstChild; q && q.K && (-1 == q.K || q.K >= c);) q = q.nextSibling;
                                ...
                                k.b && (Fd++, k.a = new Image, k.a.style[T + "Origin"] = "0% 0%", k.a.style.position = "absolute", k.a.style.overflow = "hidden", k.a.crossOrigin = b.ba, k.b.K = c, n && (k.b.id = "tile" + curCfNr + "_" + c + "___" + ty + "_" + tx), k.a.onload = Nd(k), k.a.onerror = wd(k), k.a.onabort = wd(k), k.a.setAttribute("src", od(c)), level.t && b.checkLoaded.push(k.a), 0 == U && b.divSkin && b.divSkin.ggReLoadedLevels && b.divSkin.ggReLoadedLevels(), U++, b.dirty = l)
                            }
                            k.b && (a = "", ma ? (a += "translate3d(" + z / 2 + "px," + t / 2 + "px,0px) ", a += " perspective(" + h + "px) ", a += "translate3d(0px,0px," + h + "px) ") : a += "translate3d(" + z / 2 + "px," + t / 2 + "px," + h + "px) ", a += "rotateZ(" + Number(la).toFixed(10) + "deg) rotateX(" + Number(x).toFixed(10) + "deg)  rotateY(" + Number(-u).toFixed(10) + "deg) ", a = 4 > curCfNr ? a + ("rotateY(" + -90 * curCfNr + "deg)") : a + ("rotateX(" + (4 == curCfNr ? -90 : 90) + "deg)"), q = 1, qb ? (q = (2 * c + 1) * L / level.width * (Hb / L), q = sb ? 2 / Math.tan(A * Math.PI / 360) * q : 2 * q, a += " scale(" + q * m * m + ")") : q = 1 / (m * m), a += " translate3d(" + (1 / m * tx * L - ta - level.width / 2) + "px," + (1 / m * ty * L - ta - level.width / 2) + "px," + -level.width * q / 2 + "px)", n && (k.b.id = "rtile_" + Jd + "_" + curCfNr + "_" + c + "___" + ty + "_" + tx), f.F && (k.ja = l, k.b ? k.b.style[T] = a : k.a && (k.a.style[T] = a)))
                        }
                    }
                    c--
                }
                for (h = 0; h < D.length; h++) for (e in level = D[h], level.g) level.g.hasOwnProperty(e) && (k = level.g[e], !k.ja && k.b && (level.t ? (a = "translate3d(-10px,-10px,0px) scale(0.001,0.001)", k.b ? (k.b.style[T] = a, n && (k.b.id = "cache")) : k.a && (k.a.style[T] = "")) : (k.d && (k.d.clear ? k.d.clear() : k.d.clearRect(0, 0, k.d.canvas.width, k.d.canvas.height)), unusedTileCanvas.push(k.b), k.b ? (n && (k.b.id = "unused"), a = "translate3d(-10px,-10px,0px) scale(0.001,0.001)", k.b.style[T] = a, k.b.K = -1) : k.loaded && s.removeChild(k.a), k.b = o, k.a = o, k.d = o, delete level.g[e])));
                b.T = r
            }
        } else {
            Ua();
            ...
            e = Math.round(b.S());
            if ((b.ga != e || n) && !ma) b.ga = e, s.style[za] = e + "px";
            b.f.za(u, x);
            for (n = 0; 6 > n; n++) if (h = b.f.j[n]) a = "", ma ? (a += "translate3d(" + z / 2 + "px," + t / 2 + "px,0px) ", a += "perspective(" + e + "px) ", a += "translate3d(0px,0px," + e + "px) ") : a += "translate3d(" + z / 2 + "px," + t / 2 + "px," + e + "px) ", a += "rotateZ(" + Number(la).toFixed(10) + "deg) rotateX(" + Number(x).toFixed(10) + "deg)  rotateY(" + Number(-u).toFixed(10) + "deg) ", h.Pa && (a += h.Pa, h.F || (a = "translate3d(-10px,-10px,0px) scale(0.001,0.001)"), h.style[T] = a)
        } else if (yb) {
            Ua();
            na && (h = na.getContext("2d"));
            if (z != s.offsetWidth || t != s.offsetHeight) z = parseInt(s.offsetWidth), t = parseInt(s.offsetHeight);
            h && (e = h.canvas.width / 2, n = h.canvas.height / 2, a = h.createRadialGradient(e, n, 5, e, n, Math.max(e, n)), a.addColorStop(0, "#333"), a.addColorStop(1, "#fff"), h.rect(0, 0, h.canvas.width, h.canvas.height), h.fillStyle = a, h.fill(), h.fillStyle = "#f00", h.font = "20px Helvetica", h.textAlign = "center", h.fillText("Pan: " + u.toFixed(1), e, n - 30), h.fillText("Tilt: " + x.toFixed(1), e, n), h.fillText("Fov: " + A.toFixed(1), e, n + 30))
        }
        bc()
    };
    var ma = r,
    ...
    b.setRenderFlags = function(a) {
        ...
        qb = a & 2;
        Yb = a & 4;
        4096 <= a && (Ca = a & 4096, ga = a & 8192, yb = a & 32768)
    };
    ...
    b.initWebGL = function(a) {
        Lc = r;
        try {
            if (Ba = a ? a : document.createElement("canvas"), Ba.width = 100, Ba.height = 100, s.appendChild(Ba), (g = Ba.getContext("webgl")) || (g = Ba.getContext("experimental-webgl")), g) {
                g.Ja = 500;
                g.Ia = 500;
    ...
    b.getPanN = function() {
        for (var a = u; - 180 > a;) a += 360;
        for (; 180 < a;) a -= 360;
        return a
    };
    b.getPanNorth = function() {
        for (var a = u - Xb; - 180 > a;) a += 360;
        for (; 180 < a;) a -= 360;
        return a
    };
    b.setPan = function(a) {
    ...
    b.moveTo = function(a, b, c, f) {
        ...
        1 < e.length && (a = Number(e[0]), f = b, b = Number(e[1]), 2 < e.length && (c = Number(e[2])));
        ic = isNaN(a) ? u : a;
        jc = isNaN(b) ? x : b;
    ...
    b.playSound = function(a, b) {
        var c = B(a);
        c && (c.obj.r = b && !isNaN(Number(b)) ? Number(b) - 1 : c.loop - 1, -1 == c.obj.r && (c.obj.r = 1E7), c.obj.play())
    };
    ...
    b.setVolume = function(a, b) {
        ...
        if ("_main" == a) {
            ...
            for (c = 0; c < y.length; c++) y[c].obj.volume = y[c].i * Y
        } else {
            var f = B(a);
    ...
    b.changeVolume = function(a, b) {
        if ("_main" == a) {
            ...
            var f = B(a);
            f && (c = f.i, c += Number(b), 1 < c && (c = 1), 0 > c && (c = 0), f.i = c, f.obj.volume = c * Y)
        }
    };
    ...
    b.createLayers = function(a) {
        ...
        b.da ? (b.da.innerHTML = "", b.c = document.createElement("div"), d && b.c.setAttribute("id", "viewport"), a = "top:  0px;left: 0px;position:relative;-ms-touch-action: none;" + (I + "user-select: none;"), a += I + "touch-callout: none;", a += I + "tap-highlight-color: rgba(0,0,0,0);", b.c.setAttribute("style", a), b.da.appendChild(b.c), s = document.createElement("div"), a = "top:  0px;left: 0px;width:  100px;height: 100px;overflow: hidden;position:absolute;" + (I + "user-select: none;"), a += I + "touch-callout: none;", a += I + "tap-highlight-color: rgba(0,0,0,0);", d && s.setAttribute("id", "viewer"), s.setAttribute("style", a), b.c.appendChild(s), S = document.createElement("div"), d && S.setAttribute("id", "hotspots"), a = "top:  0px;left: 0px;width:  100px;height: 100px;overflow: hidden;position:absolute;z-index: 1000;", Qd && (a += "background-image: url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7);"), sb && !ga && (a += I + "transform: translateZ(9999999px);"), a += I + "user-select: none;", a += I + "touch-callout: none;", a += I + "tap-highlight-color: rgba(0,0,0,0);", S.setAttribute("style", a), b.c.appendChild(S), $ = document.createElement("canvas"), d && $.setAttribute("id", "hotspotcanvas"), a = "top:  0px;left: 0px;width:  100px;height: 100px;overflow: hidden;position:absolute;z-index: 900;" + (I + "user-select: none;"), a += I + "pointer-events: none;", a += I + "touch-callout: none;", a += I + "tap-highlight-color: rgba(0,0,0,0);", $.setAttribute("style", a), b.c.appendChild($), M = document.createElement("div"), d && M.setAttribute("id", "hotspottext"), M.setAttribute("style", "top:  0px;left: 0px;position:absolute;padding: 3px;visibility: hidden;z-index: 1100;"), M.innerHTML = " Hotspot text!", b.c.appendChild(M), b.divSkin = S) : alert("container not found!")
    };
    b.Ma = function(a) {
        var d, c, f, e = 128;
        pb && (s.style.backgroundColor = pb.replace("0x", "#"));
        a ? (e = Hb, Gb = 1) : nb > e && (e = nb);
        for (f = 0; 6 > f; f++) {
            a ? (c = {}, c.width = Hb, c.height = Hb) : (c = document.createElement("canvas"), c.width = nb, c.height = nb, c.d = c.getContext("2d"));
            d = "position:absolute;";
            d += "left: 0px;";
            d += "top: 0px;";
            d += "width: " + e + "px;";
        ...
        if (!a) {
            for (f = 0; 6 > f; f++) c = b.f.j[f], "" != mb[f] && (c.A = new Image, c.A.onload = H(c), c.A.crossOrigin = b.ba, c.A.setAttribute("src", pa(mb[f])), b.checkLoaded.push(c.A));
            for (f = 0; 6 > f; f++) c = b.f.j[f], c.loaded = r, c.a = new Image, c.a.onload = H(c), c.a.crossOrigin = b.ba, c.a.setAttribute("src", pa(Wb[f])), b.checkLoaded.push(c.a)
        }
    };
    b.setOverlayOpacity = function(a) {
        var d;
        if (Ca) for (d = 0; 6 > d; d++) b.f.la[d] && b.f.la[d].style && (b.f.la[d].style.opacity = a)
    };
    b.removePanorama = function() {
        var a;
        if (Ca) {
            for (a = 0; a < b.f.j.length; a++) b.f.j[a].setAttribute && (b.f.j[a].setAttribute("src", "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAIAAABLbSncAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA5JREFUeNpiYBgeACDAAADIAAE3iTbkAAAAAElFTkSuQmCC"), s.removeChild(b.f.j[a]));
            if (D) {
                for (a = 0; a < D.length; a++) {
                    var d = D[a],
                        c;
                    for (c in d.g) if (d.g.hasOwnProperty(c)) {
                        var f = d.g[c];
                        f.ja = r;
        ...
        if (g && da) for (; 0 < da.length;) c = da.pop(), c.eb = l, g.deleteTexture(c);
        for (a = 0; a < y.length; a++) s.removeChild(y[a].obj);
        for (a = 0; a < fa.length; a++) s.removeChild(fa[a].obj);
        c = [];
        for (a = 0; a < C.length; a++) if (d = C[a], 0 == d.mode || 1 == d.mode || d.ib) c.push(d);
        else {
            try {
                d.obj.pause()
            } catch (e) {}
    ...
    b.readConfigXml = function(a, d) {
        ...
        if ("tour" == c.nodeName) {
            ...
            for (c = c.firstChild; c;) {
                e = "";
                if ("panorama" == c.nodeName && (e = c.getAttributeNode("id"))) e = e.nodeValue.toString(), "" == f && (f = e), ob[e] = c, va.push(e);
                c = c.nextSibling
            }
            b.Ca(ob[f], d);
            p("{" + f + "}");
            b.Ba = l
        } else b.Ba = r, b.Ca(c, d), p(""), va.push("")
    };
    b.Ca = function(a, d) {
        b.removeHotspots();
        b.hotspot = b.emptyHotspot;
        ...
        for (var c = a.firstChild, f, e, h, p = 0; c;) {
            if ("view" == c.nodeName) {
                ...
                for (f = c.firstChild; f;)"start" == f.nodeName && (e = f.getAttributeNode("pan"), Ic = u = Number(e ? e.nodeValue : 0), e = f.getAttributeNode("tilt"), Jc = x = Number(e ? e.nodeValue : 0), e = f.getAttributeNode("fov"), Mb = A = Number(e ? e.nodeValue : 70)), "min" == f.nodeName && (e = f.getAttributeNode("pan"), ib = 1 * (e ? e.nodeValue : 0), e = f.getAttributeNode("tilt"), La = 1 * (e ? e.nodeValue : -90), e = f.getAttributeNode("fov"), ka = 1 * (e ? e.nodeValue : 5), 1.0E-20 > ka && (ka = 1.0E-20), e = f.getAttributeNode("fovpixel"), Cc = 1 * (e ? e.nodeValue : 0)), "max" == f.nodeName && (e = f.getAttributeNode("pan"), hb = 1 * (e ? e.nodeValue : 0), e = f.getAttributeNode("tilt"), Ka = 1 * (e ? e.nodeValue : 90), e = f.getAttributeNode("fov"), sa = 1 * (e ? e.nodeValue : 120), 180 <= sa && (sa = 179.9)), f = f.nextSibling
            }
            if ("autorotate" == c.nodeName && ((e = c.getAttributeNode("speed")) && (Ra = 1 * e.nodeValue), (e = c.getAttributeNode("delay")) && (nc = 1 * e.nodeValue), (e = c.getAttributeNode("returntohorizon")) && (Lb = 1 * e.nodeValue), (e = c.getAttributeNode("nodedelay")) && (mc = 1 * e.nodeValue), (e = c.getAttributeNode("noderandom")) && (Rc = 1 == e.nodeValue), $b && (ia = Ab = l, jb = (new Date).getTime()), e = c.getAttributeNode("startloaded")))(oc = 1 == e.nodeValue) && (ia = r);
            "input" == c.nodeName && (h || (h = c));
            if (h) for (f = 0; 6 > f; f++) e = h.getAttributeNode("prev" + f + "url"), mb[f] = e ? new String(e.nodeValue) : "";
            ...
            if ("control" == c.nodeName && $b) {
                ...
                if (e = c.getAttributeNode("sensitivity")) gb = 1 * e.nodeValue, 1 > gb && (gb = 1);
                (e = c.getAttributeNode("dblclickfullscreen")) && (sc = 1 == e.nodeValue)
            }
            "overlay" == c.nodeName && ((e = c.getAttributeNode("blendspeed")) && (kb = 1 * e.nodeValue), (e = c.getAttributeNode("auto")) && (Sc = 1 == e.nodeValue), (e = c.getAttributeNode("delay")) && (Tc = 1 * e.nodeValue));
            ...
            if ("hotspots" == c.nodeName) for (f = c.firstChild; f;) {
                if ("label" == f.nodeName) {
                    ...
                    if (e = f.getAttributeNode("background")) k.background = 1 == e.nodeValue;
                    if (e = f.getAttributeNode("backgroundalpha")) k.O = 1 * e.nodeValue;
                    if (e = f.getAttributeNode("backgroundcolor")) k.P = 1 * e.nodeValue;
                    if (e = f.getAttributeNode("border")) k.ya = 1 * e.nodeValue;
                    if (e = f.getAttributeNode("bordercolor")) k.R = 1 * e.nodeValue;
                    if (e = f.getAttributeNode("borderalpha")) k.Q = 1 * e.nodeValue;
                    if (e = f.getAttributeNode("borderradius")) k.xa = 1 * e.nodeValue;
                    if (e = f.getAttributeNode("wordwrap")) k.wordwrap = 1 == e.nodeValue
                }
                "polystyle" == f.nodeName && ((e = f.getAttributeNode("mode")) && (R = 1 * e.nodeValue), (e = f.getAttributeNode("bordercolor")) && (Dc = 1 * e.nodeValue), (e = f.getAttributeNode("backgroundcolor")) && (Fc = 1 * e.nodeValue), (e = f.getAttributeNode("borderalpha")) && (Ec = 1 * e.nodeValue), (e = f.getAttributeNode("backgroundalpha")) && (Gc = 1 * e.nodeValue));
                "hotspot" == f.nodeName && (k = {
                    ...
                    obj: o,
                    ia: o
                }, e = f.getAttributeNode("pan"), k.pan = 1 * (e ? e.nodeValue : 0), e = f.getAttributeNode("tilt"), k.tilt = 1 * (e ? e.nodeValue : 0), (e = f.getAttributeNode("url")) && (k.url = e.nodeValue.toString()), (e = f.getAttributeNode("target")) && (k.target = e.nodeValue.toString()), (e = f.getAttributeNode("title")) && (k.title = e.nodeValue.toString()), (e = f.getAttributeNode("id")) && (k.id = e.nodeValue.toString()), (e = f.getAttributeNode("skinid")) && (k.skinid = e.nodeValue.toString()), (e = c.getAttributeNode("width")) && (k.w = e.nodeValue.toString()), (e = c.getAttributeNode("height")) && (k.h = e.nodeValue.toString()), (e = c.getAttributeNode("wordwrap")) && (k.wordwrap = 1 == e.nodeValue), J.push(k));
            ...
            if ("sounds" == c.nodeName || "media" == c.nodeName) for (f = c.firstChild; f;) {
                if ("sound" == f.nodeName) {
                    ...
                    if (e = f.getAttributeNode("ambientlevel")) n.ca = Number(e.nodeValue);
                    ...
                    if (e = f.getAttributeNode("tiltsize")) n.N = Number(e.nodeValue);
                ...
                if ("video" == f.nodeName) {
                    ...
                    if (e = f.getAttributeNode("rotz")) n.B = Number(e.nodeValue);
                    if (e = f.getAttributeNode("fov")) n.J = Number(e.nodeValue);
                    if (e = f.getAttributeNode("width")) n.z = Number(e.nodeValue);
                    if (e = f.getAttributeNode("height")) n.D = Number(e.nodeValue);
        ...
        if (h) {
            for (f = 0; 6 > f; f++)(e = h.getAttributeNode("tile" + f + "url")) && (Wb[f] = new String(e.nodeValue));
            for (f = 0; 6 > f; f++)(e = h.getAttributeNode("prev" + f + "url")) && (mb[f] = new String(e.nodeValue));
            ...
            if (e = h.getAttributeNode("leveltileurl")) pd = e.nodeValue;
            ...
            for (f = h.firstChild; f;) {
                if ("preview" == f.nodeName && (e = f.getAttributeNode("color"))) pb = e.nodeValue;
                "level" == f.nodeName && (h = {}, e = f.getAttributeNode("width"), h.width = 1 * (e ? e.nodeValue : 1), h.height = 1 * (e ? e.nodeValue : 1), e = f.getAttributeNode("preload"), h.t = r, e && (h.t = 1 == e.nodeValue), e = f.getAttributeNode("preview"), h.Ta = r, e && (h.Ta = 1 == e.nodeValue), h.H = Math.floor((h.width + L - 1) / L), h.aa = Math.floor((h.height + L - 1) / L), h.g = {}, D.push(h));
                f = f.nextSibling
            }
        }
        yb && (ga = Ca = r, na = document.createElement("canvas"), na.width = 100, na.height = 100, na.id = "dummycanvas", s.appendChild(na), Aa());
        ga && g && (md(Gb), nd());
        Ca && (0 < D.length ? b.Ma(l) : b.Ma(), b.ga = 0);
    ...
    b.openNext = function(a, d) {
        ...
        K();
        if ("{" == a.charAt(0)) if (f = a.substr(1, a.length - 2), ob[f]) b.Ca(ob[f], c), p(a);
        else {
    ...
    b.getNodeUserdata = function(a) {
        ...
        if (a = ob[a]) for (a = a.firstChild; a;) {
