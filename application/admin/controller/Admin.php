...
class Admin extends Controller {
    ...
    protected function _initialize(){
        ...
        $this->moduleName = $request->module();//模块
        $this->controllerName = $request->controller();//控制器
        $this->actionName = $request->action();//方法
...
//                }
    ...
    /**
     * 西湖十景 默认图片
     * $front_pic 封面图片id：25-34
     * $list_pic 列表图片id：35-44
     * $carousel_pic 轮播图片id: 45-54
     */
    public function default_pic(){
        //随机封面图
        $a = array('25'=>'a','26'=>'b','27'=>'c','28'=>'d','29'=>'e','30'=>'f','31'=>'g','32'=>'h','33'=>'i','34'=>'j');
        $front_pic = array_rand($a,1);
        $this->assign('front_pic',$front_pic);

        //随机列表图
        $b = array('35'=>'a','36'=>'b','37'=>'c','38'=>'d','39'=>'e','40'=>'f','41'=>'g','42'=>'h','43'=>'i','44'=>'j');
        $list_pic = array_rand($b,1);
        $this->assign('list_pic',$list_pic);

        //随机轮播图
        $c = array('45'=>'a','46'=>'b','47'=>'c','48'=>'d','49'=>'e','50'=>'f','51'=>'g','52'=>'h','53'=>'i','54'=>'j');
    ...
    /**
     * 杭州g20 图片
     * $front_pic 封面图片id：123-127
     * $list_pic 列表图片id：128-132
     * $carousel_pic 轮播图片id: 133-137
     */
    public function default_pic2(){
        //随机封面图
        $a = array('123'=>'a','124'=>'b','125'=>'c','126'=>'d','127'=>'e');
        $front_pic = array_rand($a,1);
        $this->assign('front_pic',$front_pic);

        //随机列表图
        $b = array('128'=>'a','129'=>'b','130'=>'c','131'=>'d','132'=>'e');
        $list_pic = array_rand($b,1);
        $this->assign('list_pic',$list_pic);

        //随机轮播图
        $c = array('133'=>'a','134'=>'b','135'=>'c','136'=>'d','137'=>'e');
        $carousel_pic1 = array_rand($c,1);
        $this->assign('carousel_pic1',$carousel_pic1);
        $carousel_pic2 = array_rand($c,1);
        $this->assign('carousel_pic2',$carousel_pic2);
