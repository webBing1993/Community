...
//        $data = array(
//            'departmentTotal' => count($list['department']),
//            'tagsTotal' => count($tags['taglist']),
//            'userTotal' => count($users['userlist'])
//        );
//        $data = "同步部门数:".count($list['department']).",标签数:".count($tags['taglist'])."用户数:".count($users['userlist'])."!";
